...
import GetNotify from './get-notify.jsx';
import WriteNotify from './write-notify.jsx';
import AddUser from './add-user.jsx';
import UserList from './user-list.jsx';
import GetIps from './get-ips.jsx';
import ShowTable from './show-table.jsx';
import EditTable from './edit-table.jsx';
    ...
    render() {
        ...
        if ( master ) {
            if ( this.state.notify ) {
                ...
                historyData = <EditTable url="/master/data/history" edit="true"></EditTable>
            ...
            if ( this.state.notify ) {
                ...
                historyData = <ShowTable url="/channel/data/history"></ShowTable>
            }
        }

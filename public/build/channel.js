...
var _css2 = __webpack_require__(1076);
...
var _css4 = __webpack_require__(82);

var _input = __webpack_require__(81);

var _input2 = _interopRequireDefault(_input);

var _css5 = __webpack_require__(182);

var _select = __webpack_require__(85);

var _select2 = _interopRequireDefault(_select);

var _css6 = __webpack_require__(597);
...
var _search = __webpack_require__(1086);
    ...
    function UserList(props) {
        ...
        _this3.getData = function () {
            ...
            _axios2.default.get(url, _extends({
                ...
                var pagination = _extends({}, _this3.state.pagination);
        ...
        _this3.search = function () {
            ...
            _this3.getData(dataObj, '/master/search/channel');
        };

        _this3.postModifyUser = function () {
            ...
            data.isNew = false;
            _axios2.default.post('/master/newchannel', data).then(function (json) {
                json = json.data;
                if (json.success) {
                    alert('用户修改成功');
                    location.reload();
    ...
    _createClass(UserList, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_search2.default, { searchData: this.search }),
                _react2.default.createElement('br', null),
...
var EditableTable = function (_React$Component2) {
    ...
    function EditableTable(props) {
        ...
        _this3.columns = [{
            ...
            render: function render(text, record, index) {
                return _this3.renderColumns(_this3.state.data, index, 'gmt_modified', text);
            }
        }, {
            title: '用户名',
            dataIndex: 'username',
    ...
    _createClass(EditableTable, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_search2.default, { isData: 'true', searchData: this.search }),
                _react2.default.createElement('br', null),
                _react2.default.createElement(_table2.default, {
                    bordered: true,
                    dataSource: dataSource,
...
var _css2 = __webpack_require__(170);

var _button = __webpack_require__(56);

var _button2 = _interopRequireDefault(_button);

var _css3 = __webpack_require__(82);
...
var _css5 = __webpack_require__(597);

var _form = __webpack_require__(295);

var _form2 = _interopRequireDefault(_form);

var _css6 = __webpack_require__(1092);
            ...
            if (isData) {
                children.push(_react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(RangePicker, { onChange: this.onDateSelect })
                    )
                ));
            }
            children.push(_react2.default.createElement(
...
var _breadcrumb = __webpack_require__(168);
...
var _getNotify = __webpack_require__(163);

var _getNotify2 = _interopRequireDefault(_getNotify);

var _writeNotify = __webpack_require__(1069);

var _writeNotify2 = _interopRequireDefault(_writeNotify);

var _addUser = __webpack_require__(1074);

var _addUser2 = _interopRequireDefault(_addUser);

var _userList = __webpack_require__(1079);

var _userList2 = _interopRequireDefault(_userList);

var _getIps = __webpack_require__(1082);

var _getIps2 = _interopRequireDefault(_getIps);

var _showTable = __webpack_require__(165);

var _showTable2 = _interopRequireDefault(_showTable);

var _editTable = __webpack_require__(1083);

var _editTable2 = _interopRequireDefault(_editTable);

var _exit = __webpack_require__(162);
        ...
        value: function render() {
            ...
            if (master) {
                if (this.state.notify) {
                    ...
                    historyData = _react2.default.createElement(_editTable2.default, { url: '/master/data/history', edit: 'true' });
                ...
                if (this.state.notify) {
                    ...
                    historyData = _react2.default.createElement(_showTable2.default, { url: '/channel/data/history' });
                }
            }
...
var _css2 = __webpack_require__(177);
...
module.exports = __webpack_require__(282)(global || window || undefined);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(24)))
...
exports.masterStore = exports.channelStore = undefined;

var _reducer = __webpack_require__(285);

var _reducer2 = _interopRequireDefault(_reducer);

var _masterReducer = __webpack_require__(284);

var _masterReducer2 = _interopRequireDefault(_masterReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.channelStore = _reducer2.default;
exports.masterStore = _masterReducer2.default;
...
var _breadCrumb = __webpack_require__(160);

var _breadCrumb2 = _interopRequireDefault(_breadCrumb);

var _leftSide = __webpack_require__(164);

var _leftSide2 = _interopRequireDefault(_leftSide);

var _index = __webpack_require__(29);

var _contentContainer = __webpack_require__(161);
...
var ChannelComp = function (_React$Component) {
    _inherits(ChannelComp, _React$Component);

    function ChannelComp() {
        _classCallCheck(this, ChannelComp);

        return _possibleConstructorReturn(this, (ChannelComp.__proto__ || Object.getPrototypeOf(ChannelComp)).apply(this, arguments));
    }

    _createClass(ChannelComp, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_leftSide2.default, { master: 'false' })
                ),
                _react2.default.createElement(
                    _layout2.default,
                    null,
...
var _channelContainer = __webpack_require__(543);

var _channelContainer2 = _interopRequireDefault(_channelContainer);
...
var render = function render() {
    _reactDom2.default.render(_react2.default.createElement(_channelContainer2.default, null), rootEle);
};

render();
_index.channelStore.subscribe(render);
